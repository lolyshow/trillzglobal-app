...
<head>
    <meta charset="utf-8" />
    <title>Datatables | Naijago App - Responsive Bootstrap 4 Admin Dashboard</title>
        ...
        <div class="left-side-menu">
            ...
            <div class="h-100" id="left-side-menu-container" data-simplebar>
                ...
                <ul class="metismenu side-nav">
                    ...
                    <li class="side-nav-item">
                        <a href="{{url('transaction')}}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{url('team')}}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{url('Sponsor')}}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{url('race')}}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{url('post')}}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{url('condition')}}" class="side-nav-link">
                            <i class="fas fa-crosshairs"></i>
                            <span>Conditions</span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a href="{{url('chat')}}" class="side-nav-link">
                            <i class="fas fa-sms"></i>
                            <span>Chat Group</span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a href="{{url('campaign')}}" class="side-nav-link">
                            <i class="fas fa-people-carry"></i>
                            <span>Campaign</span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a href="{{url('Condition_entry')}}" class="side-nav-link">
                            <i class="uil-layer-group"></i>
                            <span>Condition Entry</span>
                        </a>
                    </li>
                </ul>
                <!-- End Sidebar -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> © Naijago App - Coderthemes.com
                        </div>
                        <div class="col-md-6">
